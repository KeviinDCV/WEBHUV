...
@section('description', $topic->metaDescription() ?: __('paginas.tema.descripcion', [
    'tema' => $topic->name,
    ...
    <div class="bg-page" x-data='huvTopicList(@json($topicConfig))'>
        <x-container class="py-8 lg:py-10">
            ...
            @else
                ...
                @else
                    {{-- El título va oculto: el listado se entiende solo, pero sin
                     él se saltaba del h1 de la página a los h3 de cada ficha. --}}
